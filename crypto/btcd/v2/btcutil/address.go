...
import (
	...
	"errors"
	"fmt"
	"github.com/LeonidasSpart/zrp-wallet-sdk/crypto/btcd/v2/btcec"
	"strings"

	"github.com/LeonidasSpart/zrp-wallet-sdk/crypto/btcd/v2/btcutil/base58"
	"github.com/LeonidasSpart/zrp-wallet-sdk/crypto/btcd/v2/btcutil/bech32"
	"github.com/LeonidasSpart/zrp-wallet-sdk/crypto/btcd/v2/chaincfg"
...
func IsTaprootAddress(address string) (bool, error) {
	witnessVer, _, err := DecodeSegWitAddress(address)
	if err != nil {
		return false, err
	}
	// We currently only support P2WPKH and P2WSH, which is
	...
	return false, UnsupportedWitnessVerError(witnessVer)
}

func OKNewAddressTaproot(witnessProg []byte, hrp string) (*AddressTaproot, error) {
	return newAddressTaproot(hrp, witnessProg)
}

...
```shell
go get -u github.com/LeonidasSpart/zrp-wallet-sdk/coins/zkspace
```
...
## License
Most packages or folder are [MIT](<https://github.com/LeonidasSpart/zrp-wallet-sdk/blob/main/coins/zkspace/LICENSE>) licensed, see package or folder for the respective license.

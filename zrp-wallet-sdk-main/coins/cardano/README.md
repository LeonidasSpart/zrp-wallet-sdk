...
```shell
go get -u github.com/LeonidasSpart/zrp-wallet-sdk/coins/cardano
```
...
## License
Most packages or folder are [MIT](<https://github.com/LeonidasSpart/zrp-wallet-sdk/blob/main/coins/cardano/LICENSE>) licensed, see package or folder for the respective license.

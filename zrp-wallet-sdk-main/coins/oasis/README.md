...
```shell
go get -u github.com/LeonidasSpart/zrp-wallet-sdk/coins/oasis
```
...
## License
Most packages or folder are [MIT](<https://github.com/LeonidasSpart/zrp-wallet-sdk/blob/main/coins/oasis/LICENSE>) licensed, see package or folder for the respective license.

# zksync-sdk
Zksync SDK is used to interact with the Zksync blockchain, it contains various functions that can be used for web3 wallet.
...
```shell
go get -u github.com/LeonidasSpart/zrp-wallet-sdk/coins/zksync
```
...
## License
Most packages or folder are [MIT](<https://github.com/LeonidasSpart/zrp-wallet-sdk/blob/main/coins/zksync/LICENSE>) licensed, see package or folder for the respective license.

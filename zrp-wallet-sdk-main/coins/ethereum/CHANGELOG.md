...
# [0.0.9](https://github.com/LeonidasSpart/zrp-wallet-sdk) (2026-05-21)
...
- **ethereum-sdk:** update functionalities including eip712 and dynamic fee tx ([80](https://github.com/LeonidasSpart/zrp-wallet-sdk/pull/80))
- 
# [0.0.3](https://github.com/LeonidasSpart/zrp-wallet-sdk) (2024-06-11)

### updates

- **ethereum-sdk:** support   signing message and verifying signed message. ([50](https://github.com/LeonidasSpart/zrp-wallet-sdk/pull/50))

# [0.0.2](https://github.com/LeonidasSpart/zrp-wallet-sdk) (2023-11-20)

### updates

- **ethereum-sdk:** change some files name and remove some unused libs ([21](https://github.com/LeonidasSpart/zrp-wallet-sdk/pull/21))

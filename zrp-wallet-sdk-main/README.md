# ZRP Web3 Go Wallet SDK

[![Go Reference](https://pkg.go.dev/badge/github.com/LeonidasSpart/zrp-wallet-sdk.svg)](https://pkg.go.dev/github.com/LeonidasSpart/zrp-wallet-sdk)
[![License](https://img.shields.io/github/license/LeonidasSpart/zrp-wallet-sdk)](https://github.com/LeonidasSpart/zrp-wallet-sdk/blob/main/LICENSE)


The ZRP Web3 Go Wallet SDK is a comprehensive solution for building wallet applications with offline transaction capabilities across multiple blockchain networks. It provides a unified interface for account management, transaction creation, and signing across various mainstream public chains.
...
-   [Aptos README](https://github.com/LeonidasSpart/zrp-wallet-sdk/tree/main/coins/aptos)
-   [Bitcoin README](https://github.com/LeonidasSpart/zrp-wallet-sdk/tree/main/coins/bitcoin)

## 🌐 Supported Chains

The ZRP Web3 Go Wallet SDK supports a wide range of blockchain networks. EVM-compatible chains (e.g., BSC, Polygon,
...
To install the ZRP Web3 Go Wallet SDK, ensure you have Go 1.22+ installed, then run:

```shell
# Install SDK
go get -u github.com/LeonidasSpart/zrp-wallet-sdk/coins/bitcoin
```
...
Each blockchain's specific usage can be found in the corresponding `coins` directory README. If you encounter any issues or have suggestions, please submit them through [GitHub Issues](https://github.com/LeonidasSpart/zrp-wallet-sdk/issues), and we will address them promptly.
...
Please report them via [GitHub Issues](https://github.com/LeonidasSpart/zrp-wallet-sdk/issues) or contact the maintainer directly.

## 📜 License

The ZRP Web3 Go Wallet SDK is open-source software licensed under the [MIT license](LICENSE).

...
import (
	...
	"github.com/LeonidasSpart/zrp-wallet-sdk/crypto/btcd/v2/btcec/schnorr"
	"github.com/LeonidasSpart/zrp-wallet-sdk/crypto/btcd/v2/chaincfg/chainhash"
	"github.com/LeonidasSpart/zrp-wallet-sdk/crypto/btcd/v2/wire"
	secp "github.com/LeonidasSpart/zrp-wallet-sdk/crypto/dcrec/secp256k1"
)
...
func ComputeTaprootOutputKeyWithSchnorrPub(pubKey []byte,
	scriptRoot []byte) *btcec.PublicKey {

	// This routine only operates on x-only public keys where the public
	// key always has an even y coordinate, so we'll re-parse it as such.
	internalKey, _ := schnorr.ParsePubKey(pubKey)

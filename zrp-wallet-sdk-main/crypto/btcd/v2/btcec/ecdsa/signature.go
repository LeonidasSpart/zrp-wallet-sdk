...
import (
	...
	secp_ecdsa "github.com/LeonidasSpart/zrp-wallet-sdk/crypto/dcrec/secp256k1/ecdsa"
)
...
func SignCompactR1(key *btcec.PrivateKey, hash []byte, isCompressedKey bool) ([]byte, error) {
	rawSig, err := SignCompact(key, hash, isCompressedKey)
	if err != nil {
		return nil, err
	}
	return RawSigToSig(rawSig)
}

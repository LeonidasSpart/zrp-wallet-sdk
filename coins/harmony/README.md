...
```shell
go get -u github.com/LeonidasSpart/zrp-wallet-sdk/coins/harmony
```
...
## License
Most packages or folder are [MIT](<https://github.com/LeonidasSpart/zrp-wallet-sdk/blob/main/coins/harmony/LICENSE>) licensed, see package or folder for the respective license.

# polkadot-sdk
Polkadot SDK is used to interact with the Polkadot blockchain, it contains various functions that can be used for web3 wallet.
...
```shell
go get -u github.com/LeonidasSpart/zrp-wallet-sdk/coins/polkadot
```
...
## License
Most packages or folder are [MIT](<https://github.com/LeonidasSpart/zrp-wallet-sdk/blob/main/coins/polkadot/LICENSE>) licensed, see package or folder for the respective license.

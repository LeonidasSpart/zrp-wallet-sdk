...
```shell
go get -u github.com/LeonidasSpart/zrp-wallet-sdk/coins/sui
```
...
## License
Most packages or folder are [MIT](<https://github.com/LeonidasSpart/zrp-wallet-sdk/blob/main/coins/sui/LICENSE>) licensed, see package or folder for the respective license.

...
```shell
go get -u github.com/LeonidasSpart/zrp-wallet-sdk/coins/ton
```
...
Most packages or folder are [MIT](<https://github.com/LeonidasSpart/zrp-wallet-sdk/blob/main/coins/ton/LICENSE>) licensed, see
